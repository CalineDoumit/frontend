import {
    ...
    CardTitle, Breadcrumb, BreadcrumbItem, Button,Navbar,NavbarBrand, Nav, NavbarToggler,NavItem,
} from 'reactstrap';
...
class PatientMenu extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            mypatient: this.props.mypatient,
        }
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(PatientMenu));
